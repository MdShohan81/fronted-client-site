...
const InventoryCard = (props) => {
    const {carname, img,price,suppliername,rating,quantity,description} = props.car
    return (
        ...
        <div class="card-body">
            ...
            <button class="btn btn-md btn-secondary px-8 animate-bounce transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-primary duration-700 border-none">Update</button>
            </div>
        </div>
        </div>
    );
